...
export const data = new SlashCommandBuilder()
    .setName('setname')
    .setDescription('Setzt und Speichert den Namen deines temporären Sprachkanals.')
...
export async function execute(interaction) {
    ...
    try {
        if (!channelId) {
            ...
            await interaction.reply({content: `Der Name deines Sprachkanals wurde zu **${name}** geändert.`, ephemeral: true});
